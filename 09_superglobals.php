...
<body>
   <ul>
     ...
     <li>Current File Dir: <?php echo $_SERVER['PHP_SELF']; ?></li><!-- 同じファイルにフォームを送信する場合にとても有用 -->
     <li>Request URI: <?php echo $_SERVER['REQUEST_URI']; ?></li><!-- URIはURL（Web上の住所）とURN（Web上の名前）を合わせたもの -->
