...
?>
<img src="/PHP%20For%20Beginners3.5%20hours/feedback/img/logo.png" class="w-25 mb-3" alt="">
<h2>Feedback</h2>
<p class="lead text-center">Leave feedback for Traversy Media</p>
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?> " method="POST" class="mt-4 w-75">
  <!-- methodはpost, htmlspecialcharsで<script>の攻撃を防ぐ -->
  <div class="mb-3">
    <label for="name" class="form-label">Name</label>
    <input type="text" class="form-control <?php echo $nameErr ? 'is-invalid' : null; ?>" id="name" name="name" placeholder="Enter your name"><!-- name入力が無効であればis-invalidのクラスをつけてエラーを表示する -->
